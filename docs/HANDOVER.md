# falkor-agent — Handover

**Repo:** [github.com/PaddyGallivan/falkor-agent](https://github.com/PaddyGallivan/falkor-agent)
...
## What this is
CF Worker falkor-agent — deploys via GH Actions. NO LOCAL INFRA.
